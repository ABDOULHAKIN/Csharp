...
namespace Festival.Web.Controllers
{
    public class GroupesController : Controller
    {
        ...
        public GroupesController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Groupe != null ? 
                          ...
                          Problem("Entity set 'ApplicationContext.Groupe'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,DateCreation")] Groupe groupe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,DateCreation")] Groupe groupe)
        {
            if (id != groupe.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationContext.Groupe'  is null.");
            }
            var groupe = await _context.Groupe.FindAsync(id);
            if (groupe != null)
            {
